    ...
    <div className="min-h-screen bg-gradient-to-b from-zinc-900 via-zinc-900 to-black text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          <div className="inline-block mb-4 px-4 py-2 bg-yellow-500/20 border border-yellow-500/50 rounded-full text-yellow-400 text-sm font-semibold">
            🎮 #1 Mobile Multiplayer Game
          </div>
          <h1 className="text-6xl md:text-8xl font-black mb-6 bg-gradient-to-r from-yellow-400 via-orange-500 to-pink-500 bg-clip-text text-transparent drop-shadow-2xl">
            BRAWL STARS
          </h1>
      ...
      <section className="relative py-24 bg-gradient-to-b from-black/50 to-black/30">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
      ...
      <section className="relative py-24 bg-gradient-to-b from-purple-900/20 via-pink-900/20 to-black">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="p-8 bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                />
                <button className="px-8 py-3 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full font-bold text-black hover:scale-105 transition-transform">
                  Subscribe
                </button>
              </div>
            </div>
            ...
            <div className="flex justify-center gap-6 mt-12">
              <a href="#" className="w-12 h-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors">
